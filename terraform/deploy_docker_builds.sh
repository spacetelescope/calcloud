...
CALDP_DOCKER_IMAGE="${repo_url}:batch-${COMMON_IMAGE_TAG}_${aws_env}"
PREDICT_DOCKER_IMAGE="${repo_url}:unscanned-predict-${COMMON_IMAGE_TAG}_${aws_env}"
TRAINING_DOCKER_IMAGE="${repo_url}:unscanned-training-${COMMON_IMAGE_TAG}_${aws_env}"
